...
export default function RoadRev5({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <Text> {'\n'} </Text>
    <Text style={styles.subtitle}> Should a broken car seat be used? </Text>

    <View style={styles.buttonContainer}>
    <QuizButton
      text="Only if it was in a minor car crash"
    ></QuizButton>
    <QuizButton
      title="correct"
      text="Never"
    ></QuizButton>
    <QuizButton
      text="If it has less than two cracks"
    ></QuizButton>
    <QuizButton
      text="Only if there are no visible cracks"
    ></QuizButton>
    </View>
