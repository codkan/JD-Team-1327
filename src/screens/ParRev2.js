...
export default function ParRev2({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <Text> {'\n'} </Text>
    <Text style={styles.subtitle}> What is a long-term effect of untreated postpartum depression? </Text>

    <View style={styles.buttonContainer}>
    <QuizButton
      text="Advanced child language development"
    ></QuizButton>
    <QuizButton
      text="Emotional maturity"
    ></QuizButton>
    <QuizButton
      text="Well-behaved children"
    ></QuizButton>
    <QuizButton
      title="correct"
