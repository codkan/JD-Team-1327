...
export default function ParRev4({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <QuizButton
      text="It is treatable"
    ></QuizButton>
    <QuizButton
      text="A complication of birth"
    ></QuizButton>
    <QuizButton
      title="correct"
      text="It is a character flaw"
    ></QuizButton>
    <QuizButton
      text="May not be chronic"
    ></QuizButton>
    </View>
