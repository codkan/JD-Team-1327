...
export default function RoadRev1({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <Text> {'\n'} </Text>
    <Text style={styles.subtitle}> Where should a rear-facing carseat be installed? </Text>

    <View style={styles.buttonContainer}>
    <QuizButton
      text="No carseat needed"
    ></QuizButton>
    <QuizButton
      title="correct"
      text="Backseat"
