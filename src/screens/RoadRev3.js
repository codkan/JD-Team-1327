...
export default function RoadRev3({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <Text> {'\n'} </Text>
    <Text style={styles.subtitle}> What parts of the seatbelt should be worn at all times? </Text>

    <View style={styles.buttonContainer}>
    <QuizButton
      title="correct"
      text="Lap and Chest/Shoulder"
    ></QuizButton>
    <QuizButton
      text="Lap only"
    ></QuizButton>
    <QuizButton
      text="Chest/shoulder only"
    ></QuizButton>
    <QuizButton
      text="Neither"
    ></QuizButton>
