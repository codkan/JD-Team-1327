...
export default function ParRev3({ navigation }) {
  //NAV CALLBACK
  const goHome = () => {
    navigation.pop();
  };
  ...
  return (
    ...
    <Text> {'\n'} </Text>
    <Text style={styles.subtitle}> Which is not a side effect of children with a parent with postpartum depression? </Text>
    ...
    ></QuizButton>
    <QuizButton
      text="Too much or too little sleep"
    ></QuizButton>
    <QuizButton
