...
<Text style={styles.bullet}>1. Close, lock, and guard your windows </Text>
...
<Text style={styles.bullet}>2. Baby-proof furniture & avoid tip-overs </Text>
...
<Text style={styles.bullet}>3. Prevent dangerous falls at home </Text>
...
<Text style={styles.bullet}>4. Pay close attention at the playground </Text>
...
<Text style={styles.bullet}>5. Be mindful when seated and on the go </Text>
